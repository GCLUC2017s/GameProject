...
//	CLight::SetRadiationAngle(1, Utility::DgreeToRadian(5.0f));
	...
	CResourceManager::GetInstance()->Add("LittlePlayerW", CImage::LoadImage("Player/PlayerW.png"));
	...
	CResourceManager::GetInstance()->Add("BackGroundMoning", CImage::LoadImage("BackGround/Back/Background_M.png"));
	CResourceManager::GetInstance()->Add("BackGroundMoning2", CImage::LoadImage("BackGround/Back/Background_M.png"));
	CResourceManager::GetInstance()->Add("BackGroundMoning3", CImage::LoadImage("BackGround/Back/Background_M.png"));
	CResourceManager::GetInstance()->Add("BackGroundNoon", CImage::LoadImage("BackGround/Back/Background_M.png"));
	CResourceManager::GetInstance()->Add("BackGroundEveing", CImage::LoadImage("BackGround/Back/Background_E_3.png"));
	CResourceManager::GetInstance()->Add("BackGroundNight", CImage::LoadImage("BackGround/Back/Background_Ni.png"));
	CResourceManager::GetInstance()->Add("ResultBackGround", CImage::LoadImage("BackGround/Game_Background/Background_Ni02.png"));
	CResourceManager::GetInstance()->Add("BackGroundMoningBack", CImage::LoadImage("BackGround/Back/Background_ M_2.png"));
	CResourceManager::GetInstance()->Add("BackGroundNoonBack", CImage::LoadImage("BackGround/Back/Background_M_2.png"));
	CResourceManager::GetInstance()->Add("BackGroundEveingBack", CImage::LoadImage("BackGround/Back/Background_E_2.png"));
	CResourceManager::GetInstance()->Add("BackGroundNightBack", CImage::LoadImage("BackGround/Back/Background_Ni_2.png"));
	...
	CResourceManager::GetInstance()->Add("CarrotShot", CImage::LoadImage("Enemy/Carrot.png"));
	...
	CResourceManager::GetInstance()->Add("HPBar", CImage::LoadImage("Player/Life_waku.png"));
	CResourceManager::GetInstance()->Add("HP", CImage::LoadImage("Player/Life1.png"));
	CResourceManager::GetInstance()->Add("WordHP", CImage::LoadImage("Player/HP_2.png"));
	CResourceManager::GetInstance()->Add("HalfHP", CImage::LoadImage("Player/Life2.png"));
	CResourceManager::GetInstance()->Add("NoHP", CImage::LoadImage("Player/Life3.png"));
